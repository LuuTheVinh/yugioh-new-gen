...
{
    class FusionMonsterData : MonsterCardData
    {
        public FusionMonsterData(FusionMonsterData _monster)
        ...
        {
            this.CardType = eCardType.FUSION;
        }

        public FusionMonsterData(string _id, string _name, string _description, bool _isEffect,
